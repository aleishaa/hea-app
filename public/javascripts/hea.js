...
function build_barchart (params) {
  ...
  var bar_padding = 1;
  var bar_height = 20;
  var caption1 = params.caption1;
  var caption2 = params.caption2;
  ...
  var chart = d3.select("#charts")
    ...
    .attr('height', (bar_height) * variables.length + 71)
    .append("g")
  ...
  chart.selectAll("text.variable")
    ...
    .text(function(s) { if ( s == null ) s = 'NULL'; if ( s.length > max_variable_name_length ) { return jQuery.trim(s).substring(0,max_variable_name_length)
    .trim(this) + '...'; } else { return s; } });
}
